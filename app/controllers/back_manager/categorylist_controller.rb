...
class BackManager::CategorylistController < ApplicationController
  ...
  def list_categorylist
    ...
    @all_categorylists = Categorylist.paginate :page => params[:page], :per_page => 22,:order => "createdate desc"
    #if params[:categorylist][:categoryid].to_s != nil and params[:categorylist][:categoryid].to_s != ""
      #@all_categorylists = Categorylist.paginate :page => params[:page], :per_page => 22,:conditions => {:categoryid => params[:categorylist][:categoryid].to_s},:order => "createdate desc"        
    #else
      #@all_categorylists = Categorylist.paginate :page => params[:page], :per_page => 22,:order => "createdate desc"
    #end
  end
  ...
  def list_software
    @all_categorylists = Categorylist.paginate :page => params[:page], :per_page => 22,:conditions => {:categoryid => '003002'},:order => "createdate desc"
  end
